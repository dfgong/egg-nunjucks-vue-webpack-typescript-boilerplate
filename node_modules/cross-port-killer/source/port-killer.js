...
var Killer = (function () {
    ...
    Killer.prototype.linux = function (port) {
        ...
        var awk = child_process_1.spawn('awk', ['\$8 == "TCP" { print $2 }'], { stdio: [lsof.stdout] });
        var result = '';
    ...
    Killer.prototype.win32 = function (port) {
        ...
        var findstr = child_process_1.spawn('findstr', [":" + port + ".*LISTENING"], { stdio: ['pipe'] });
        var netstat = child_process_1.spawn('netstat', ['-ano'], { stdio: ['ignore', findstr.stdin] });
        var result = '';
